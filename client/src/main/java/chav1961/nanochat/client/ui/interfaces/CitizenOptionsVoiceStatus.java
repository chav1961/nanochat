...
public enum CitizenOptionsVoiceStatus implements UIOptionValueInterface<CitizenOptions> {
	...
	private CitizenOptionsVoiceStatus(final ContentNodeMetadata meta) {
		this(meta, false);
	}

	private CitizenOptionsVoiceStatus(final ContentNodeMetadata meta, final boolean isDefault) {
		this.meta = meta;
	...
	public CitizenOptions getOwner() {
		return CitizenOptions.VOICESTATUS;
	}
}
